...
public final class CustomSimpleExoPlayerView extends FrameLayout {
    ...
    public CustomSimpleExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.google.android.exoplayer2.R.styleable.SimpleExoPlayerView, 0, 0);
            try {
                playerLayoutId = a.getResourceId(com.google.android.exoplayer2.R.styleable.SimpleExoPlayerView_player_layout_id, playerLayoutId);
                ...
                controllerShowTimeoutMs = a.getInt(com.google.android.exoplayer2.R.styleable.SimpleExoPlayerView_show_timeout, controllerShowTimeoutMs);
            } finally {
                a.recycle();
            }
        }
