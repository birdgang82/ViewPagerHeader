...
final class ExoPlayerImplInternal implements Handler.Callback,
     ...
     * {@link com.google.android.exoplayer2.ExoPlayerImpl} and read/written internally on the player's thread.
     */
    public static final class PlaybackInfo {
        ...
        public ExoPlayerImplInternal.PlaybackInfo copyWithPeriodIndex(int periodIndex) {
            ExoPlayerImplInternal.PlaybackInfo playbackInfo = new ExoPlayerImplInternal.PlaybackInfo(periodIndex, startPositionUs);
    ...
    public static final class SourceInfo {
        ...
        public SourceInfo(Timeline timeline, Object manifest, ExoPlayerImplInternal.PlaybackInfo playbackInfo, int seekAcks) {
    ...
    private ExoPlayerImplInternal.SeekPosition pendingSeekPosition;
    private long rendererPositionUs;

    private ExoPlayerImplInternal.MediaPeriodHolder loadingPeriodHolder;
    private ExoPlayerImplInternal.MediaPeriodHolder readingPeriodHolder;
    private ExoPlayerImplInternal.MediaPeriodHolder playingPeriodHolder;

    private Timeline timeline;

    public ExoPlayerImplInternal(Renderer[] renderers, TrackSelector trackSelector,
                                 LoadControl loadControl, boolean playWhenReady, Handler eventHandler,
                                 ExoPlayerImplInternal.PlaybackInfo playbackInfo, ExoPlayer player) {
    ...
    public void seekTo(Timeline timeline, int windowIndex, long positionUs) {
        handler.obtainMessage(MSG_SEEK_TO, new ExoPlayerImplInternal.SeekPosition(timeline, windowIndex, positionUs))
                .sendToTarget();
    }
    ...
    public boolean handleMessage(Message msg) {
        try {
            switch (msg.what) {
                ...
                case MSG_SEEK_TO: {
                    seekToInternal((ExoPlayerImplInternal.SeekPosition) msg.obj);
                    return true;
                }
                case MSG_STOP: {
                    stopInternal();
...
//            eventHandler.obtainMessage(MSG_ERROR, ExoPlaybackException.createForUnexpected(e)).sendToTarget();
    ...
    private void prepareInternal(MediaSource mediaSource, boolean resetPosition) {
        ...
        if (resetPosition) {
            playbackInfo = new ExoPlayerImplInternal.PlaybackInfo(0, C.TIME_UNSET);
        }
    ...
    private void seekToInternal(ExoPlayerImplInternal.SeekPosition seekPosition) throws ExoPlaybackException {
        ...
        try {
            ...
            playbackInfo = new ExoPlayerImplInternal.PlaybackInfo(periodIndex, periodPositionUs);
            eventHandler.obtainMessage(MSG_SEEK_ACK, playbackInfo).sendToTarget();
        }
    }
    ...
    private long seekToPeriodPosition(int periodIndex, long periodPositionUs)
        ...
        ExoPlayerImplInternal.MediaPeriodHolder newPlayingPeriodHolder = null;
        if (playingPeriodHolder == null) {
            // We're still waiting for the first period to be prepared.
            ...
            ExoPlayerImplInternal.MediaPeriodHolder periodHolder = playingPeriodHolder;
    ...
    private void handleSourceInfoRefreshed(Pair<Timeline, Object> timelineAndManifest)
        ...
        if (oldTimeline == null) {
            if (pendingInitialSeekCount > 0) {
                ...
                playbackInfo = new ExoPlayerImplInternal.PlaybackInfo(periodPosition.first, periodPosition.second);
                ...
                playbackInfo = new ExoPlayerImplInternal.PlaybackInfo(defaultPosition.first, defaultPosition.second);
            }
        }

        ExoPlayerImplInternal.MediaPeriodHolder periodHolder = playingPeriodHolder != null ? playingPeriodHolder
                : loadingPeriodHolder;
        ...
        if (periodIndex == C.INDEX_UNSET) {
            ...
            playbackInfo = new ExoPlayerImplInternal.PlaybackInfo(newPeriodIndex, newPositionUs);
            notifySourceInfoRefresh(manifest, processedInitialSeekCount);
            return;
        }
        ...
        while (periodHolder.next != null) {
            ExoPlayerImplInternal.MediaPeriodHolder previousPeriodHolder = periodHolder;
            periodHolder = periodHolder.next;
            periodIndex++;
            ...
            if (periodHolder.uid.equals(period.uid)) {
                ...
                if (!seenReadingPeriod) {
                    ...
                    playbackInfo = new ExoPlayerImplInternal.PlaybackInfo(periodIndex, newPositionUs);
                } else {
    ...
    private void notifySourceInfoRefresh(Object manifest, int processedInitialSeekCount) {
        eventHandler.obtainMessage(MSG_SOURCE_INFO_REFRESHED,
                new ExoPlayerImplInternal.SourceInfo(timeline, manifest, playbackInfo, processedInitialSeekCount)).sendToTarget();
    }
    ...
    /**
     * Converts a {@link ExoPlayerImplInternal.SeekPosition} into the corresponding (periodIndex, periodPositionUs) for the
     * internal timeline.
     *
     ...
     */
    private Pair<Integer, Long> resolveSeekPosition(ExoPlayerImplInternal.SeekPosition seekPosition) {
    ...
    private void updatePeriods() throws ExoPlaybackException, IOException {
        ...
        while (playingPeriodHolder != readingPeriodHolder
            ...
            playbackInfo = new ExoPlayerImplInternal.PlaybackInfo(playingPeriodHolder.index,
    ...
    private void maybeUpdateLoadingPeriod() throws IOException {
        ...
        boolean isLastPeriod = newLoadingPeriodIndex == timeline.getPeriodCount() - 1
                && !timeline.getWindow(period.windowIndex, window).isDynamic;
        ExoPlayerImplInternal.MediaPeriodHolder newPeriodHolder = new ExoPlayerImplInternal.MediaPeriodHolder(renderers, rendererCapabilities,
    ...
    private void releasePeriodHoldersFrom(ExoPlayerImplInternal.MediaPeriodHolder periodHolder) {
        while (periodHolder != null) {
            periodHolder.release();
            periodHolder = periodHolder.next;
        }
    ...
    private void setPlayingPeriodHolder(ExoPlayerImplInternal.MediaPeriodHolder periodHolder) throws ExoPlaybackException {
    ...
    private static final class MediaPeriodHolder {
        ...
        public ExoPlayerImplInternal.MediaPeriodHolder next;
        ...
        public ExoPlayerImplInternal.TrackInfo getTrackInfo() {
            return new ExoPlayerImplInternal.TrackInfo(trackGroups, trackSelections, trackSelectionsInfo);
        }
