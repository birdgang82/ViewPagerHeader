...
public class CustomSimpleExoPlayer implements ExoPlayer {
    ...
    private static final String TAG = "CustomSimpleExoPlayer";
    protected static final int MAX_DROPPED_VIDEO_FRAME_COUNT_TO_NOTIFY = 50;

    private final ExoPlayer player;
    private final Renderer[] renderers;
    private final CustomSimpleExoPlayer.ComponentListener componentListener;
    ...
    private CustomSimpleExoPlayer.VideoListener videoListener;
    ...
    private CustomSimpleExoPlayer.PlaybackParamsHolder playbackParamsHolder;

    protected CustomSimpleExoPlayer(Context context, TrackSelector trackSelector, LoadControl loadControl,
                              DrmSessionManager<FrameworkMediaCrypto> drmSessionManager,
                              @CustomSimpleExoPlayer.ExtensionRendererMode int extensionRendererMode, long allowedVideoJoiningTimeMs) {
        mainHandler = new Handler();
        componentListener = new CustomSimpleExoPlayer.ComponentListener();
    ...
    public void setPlaybackParams(PlaybackParams params) {
        if (params != null) {
            ...
            playbackParamsHolder = new CustomSimpleExoPlayer.PlaybackParamsHolder(params);
        } else {
     ...
     */
    public void setVideoListener(CustomSimpleExoPlayer.VideoListener listener) {
    ...
    protected void buildVideoRenderers(Context context, Handler mainHandler,
                                       DrmSessionManager<FrameworkMediaCrypto> drmSessionManager,
                                       @CustomSimpleExoPlayer.ExtensionRendererMode int extensionRendererMode, VideoRendererEventListener eventListener,
    ...
    protected void buildAudioRenderers(Context context, Handler mainHandler,
                                       DrmSessionManager<FrameworkMediaCrypto> drmSessionManager,
                                       @CustomSimpleExoPlayer.ExtensionRendererMode int extensionRendererMode, AudioRendererEventListener eventListener,
                                       ArrayList<Renderer> out) {
    ...
    protected void buildTextRenderers(Context context, Handler mainHandler,
                                      @CustomSimpleExoPlayer.ExtensionRendererMode int extensionRendererMode, TextRenderer.Output output,
                                      ArrayList<Renderer> out) {
    ...
    protected void buildMetadataRenderers(Context context, Handler mainHandler,
                                          @CustomSimpleExoPlayer.ExtensionRendererMode int extensionRendererMode, MetadataRenderer.Output output,
                                          ArrayList<Renderer> out) {
    ...
    protected void buildMiscellaneousRenderers(Context context, Handler mainHandler,
                                               @CustomSimpleExoPlayer.ExtensionRendererMode int extensionRendererMode, ArrayList<Renderer> out) {
        // Do nothing.
    }
    ...
    private final class ComponentListener implements VideoRendererEventListener,
        ...
        public void onRenderedFirstFrame(Surface surface) {
            if (videoListener != null && CustomSimpleExoPlayer.this.surface == surface) {
